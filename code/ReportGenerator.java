...
public class ReportGenerator {
	...
	private final FileOutputStream reportDirectory;
	...
	private void createReport(final IBundleCoverage bundleCoverage)
		...
		final CSVFormatter htmlFormatter = new CSVFormatter();
		final IReportVisitor visitor = htmlFormatter.createVisitor(reportDirectory);
	...
	private IBundleCoverage analyzeStructure() throws IOException {
        ...
        for (final File f : classesDirectory.listFiles()) {
            ...
            try {
				analyzer.analyzeAll(in, f.getPath());
			} finally {
				in.close();
			}
        }
